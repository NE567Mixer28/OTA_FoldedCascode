...
C {devices/ipin.sym} 400 -290 0 1 {name=p4 lab=IN-}
C {devices/opin.sym} 820 -350 0 0 {name=p5 lab=OUT}
C {devices/simulator_commands_shown.sym} -1070 -520 0 0 {name=COMMANDS
simulator=ngspice
only_toplevel=false 
value="
* ngspice commands
...
.end
"}
C {sky130_fd_pr/corner.sym} -1190 -550 0 0 {name=CORNER only_toplevel=false corner=tt}
...
C {sky130_fd_pr/pfet_01v8.sym} 330 -290 0 1 {name=M2
L=2
W=50
nf=1
mult=1
...
C {devices/vsource.sym} -680 -250 0 0 {name=Vc1 value=0.7 savecurrent=false}
C {devices/lab_pin.sym} -680 -300 0 0 {name=p15 sig_type=std_logic lab=Vc1}
C {devices/lab_pin.sym} -680 -200 0 1 {name=p16 sig_type=std_logic lab=GND}
C {devices/vsource.sym} -610 -250 0 0 {name=Vc2 value=0.7 savecurrent=false}
C {devices/lab_pin.sym} -610 -300 0 0 {name=p17 sig_type=std_logic lab=Vc2
}
C {devices/lab_pin.sym} -610 -200 0 1 {name=p18 sig_type=std_logic lab=GND}
C {devices/lab_pin.sym} 620 -280 0 0 {name=p19 sig_type=std_logic lab=Vc1}
C {devices/lab_pin.sym} 610 -160 0 0 {name=p20 sig_type=std_logic lab=Vc2
}
C {devices/vsource.sym} -540 -250 0 0 {name=Vc3 value=0.7 savecurrent=false}
C {devices/lab_pin.sym} -540 -300 0 0 {name=p21 sig_type=std_logic lab=Vc3}
C {devices/lab_pin.sym} -540 -200 0 1 {name=p22 sig_type=std_logic lab=GND}
C {devices/lab_pin.sym} 600 -420 0 0 {name=p23 sig_type=std_logic lab=Vc3}
C {devices/lab_pin.sym} 290 -170 0 0 {name=p24 sig_type=std_logic lab=D1}
C {devices/lab_pin.sym} 290 -210 0 0 {name=p25 sig_type=std_logic lab=D2
